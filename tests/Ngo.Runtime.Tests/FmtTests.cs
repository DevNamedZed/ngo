...
public class FmtTests
{
    ...
    {
        var result = Fmt.Sprintf("hello %s", "world");
    ...
    {
        var result = Fmt.Sprintf("%s is %d", "age", 30);
    ...
    {
        var result = Fmt.Sprintf("%v %v %v", 1, "hi", true);
    ...
    {
        var result = Fmt.Sprintln("hello", "world");
    ...
    {
        var result = Fmt.Sprintf("%q", "hello");
    ...
    {
        var result = Fmt.Sprintf("%.2f", 3.14159);
    ...
    {
        var result = Fmt.Sprintf("%10.2f", 3.14);
        Assert.AreEqual("      3.14", result);
    }
    ...
    {
        var result = Fmt.Sprintf("%+d %+d", 42, -42);
    ...
    {
        var result = Fmt.Sprintf("%.3s", "hello");
    ...
    {
        var result = Fmt.Sprintf("%-10s", "hello");
        Assert.AreEqual("hello     ", result);
    }
