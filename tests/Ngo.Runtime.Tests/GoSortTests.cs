...
public class GoSortTests
{
    ...
    public void Ints_sorts_ascending()
    {
        ...
        Ngo.Runtime.Sort.Package.Ints(s);
    ...
    public void Float64s_sorts_ascending()
    {
        ...
        Ngo.Runtime.Sort.Package.Float64s(s);
    ...
    public void IntsAreSorted_returns_true_for_sorted()
    {
        ...
        Assert.IsTrue(Ngo.Runtime.Sort.Package.IntsAreSorted(s));
    }
    ...
    public void IntsAreSorted_returns_false_for_unsorted()
    {
        ...
        Assert.IsFalse(Ngo.Runtime.Sort.Package.IntsAreSorted(s));
    }
    ...
    public void StringsAreSorted_works()
    {
        ...
        Assert.IsTrue(Ngo.Runtime.Sort.Package.StringsAreSorted(sorted));

        var unsorted = new Slice<string>(new[] { "b", "a" });
        Assert.IsFalse(Ngo.Runtime.Sort.Package.StringsAreSorted(unsorted));
    }
    ...
    public void Float64sAreSorted_works()
    {
        ...
        Assert.IsTrue(Ngo.Runtime.Sort.Package.Float64sAreSorted(sorted));

        var unsorted = new Slice<double>(new[] { 3.0, 1.0 });
        Assert.IsFalse(Ngo.Runtime.Sort.Package.Float64sAreSorted(unsorted));
    }
    ...
    public void SearchInts_finds_insertion_point()
    {
        ...
        Assert.AreEqual(2, Ngo.Runtime.Sort.Package.SearchInts(s, 5));  // exact match
        Assert.AreEqual(2, Ngo.Runtime.Sort.Package.SearchInts(s, 4));  // between 3 and 5
        Assert.AreEqual(0, Ngo.Runtime.Sort.Package.SearchInts(s, 0));  // before all
        Assert.AreEqual(5, Ngo.Runtime.Sort.Package.SearchInts(s, 10)); // after all
    }
    ...
    public void SearchStrings_finds_insertion_point()
    {
        ...
        Assert.AreEqual(1, Ngo.Runtime.Sort.Package.SearchStrings(s, "banana"));  // exact
        Assert.AreEqual(1, Ngo.Runtime.Sort.Package.SearchStrings(s, "avocado")); // between apple and banana
    }
