// -----------------------------------------------------------------------
// <copyright file="GoUDPConn.cs" company="Ziad">
//  Copyright 2016 Ziad
//
...
namespace Ngo.Runtime.Net
{
    ...
    public class GoUDPConn : IGoNetConn
    {
        public (int, string) Read(Slice<byte> b) => (0, "not supported");
        public (int, string) Write(Slice<byte> b) => (0, "not supported");
