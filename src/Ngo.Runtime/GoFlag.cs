// -----------------------------------------------------------------------
// <copyright file="GoFlag.cs" company="Ziad">
//  Copyright 2016 Ziad
//
...
{
    public static class GoFlag
    {
        private static readonly Dictionary<string, FlagEntry> _flags = new();
        private static bool _parsed;
        private static readonly List<string> _args = new();

        public static GoFlagStringPtr String(string name, string defaultValue, string usage)
        {
            var p = new GoFlagStringPtr(defaultValue);
        ...
        private class FlagEntry
        {
            ...
            public GoFlagStringPtr? StringPtr;
    ...
    /// </summary>
    public class GoFlagStringPtr
    {
        public string Value;

        public GoFlagStringPtr(string value)
        {
            Value = value;
        }
