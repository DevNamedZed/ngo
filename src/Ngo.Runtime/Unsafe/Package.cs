...
namespace Ngo.Runtime.Unsafe
{
    ...
    public static class Package
    {
        ...
        public static object? StringData(string s)
        {
            return null; // Stub: no real pointer in .NET
        }

        public static object? SliceData<T>(Slice<T> s)
        {
            return null; // Stub: no real pointer in .NET
        }
        ...
        public static long Add([GoParam("unsafe.Pointer")] long ptr, long len)
        {
            return ptr + len;
        }
    }
