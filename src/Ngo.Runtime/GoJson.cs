// -----------------------------------------------------------------------
// <copyright file="GoJson.cs" company="Ziad">
//  Copyright 2016 Ziad
//
...
namespace Ngo.Runtime
{
    ...
    public static class GoJson
    {
        ...
        private static object? ToJsonObject(object? v)
        {
        ...
        private static void PopulateFromJson(JsonElement elem, object target)
        {
        ...
        private static (string jsonName, bool omitEmpty, bool skip) GetJsonFieldName(FieldInfo field)
        {
