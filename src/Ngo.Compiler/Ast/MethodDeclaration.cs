// -----------------------------------------------------------------------
// <copyright file="MethodDeclaration.cs" company="Ziad">
//  Copyright 2016 Ziad
//
...
namespace Ngo.Compiler.Ast
{
    ...
    {
        public MethodDeclaration(MethodSymbol symbol, ParameterSymbol receiver,
            BlockStatement body, TextSpan span)
            : this(symbol, receiver, body, Array.Empty<LocalSymbol>(), span)
        {
        }

        public MethodDeclaration(MethodSymbol symbol, ParameterSymbol receiver,
            BlockStatement body, IReadOnlyList<LocalSymbol> namedReturns, TextSpan span)
            : base(span)
        {
            Symbol = symbol;
            Receiver = receiver;
