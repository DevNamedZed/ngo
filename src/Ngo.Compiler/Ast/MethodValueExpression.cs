// -----------------------------------------------------------------------
// <copyright file="MethodValueExpression.cs" company="Ziad">
//  Copyright 2016 Ziad
//
...
{
    /// <summary>
    /// Represents a bound method value: p.String (where String is a method, not a field).
    /// The result is a function value that captures the receiver.
    /// </summary>
