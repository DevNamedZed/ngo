// -----------------------------------------------------------------------
// <copyright file="ConstSpecSyntax.cs" company="Ziad">
//  Copyright 2016 Ziad
//
...
{
    public sealed class ConstSpecSyntax : SyntaxNode
    {
        public ConstSpecSyntax(SeparatedSyntaxList<SyntaxToken> names,
        ...
        public override SyntaxKind Kind => SyntaxKind.ConstSpec;
